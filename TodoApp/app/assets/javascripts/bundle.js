...
var _todo_api_util = __webpack_require__(/*! ../util/todo_api_util.js */ "./frontend/util/todo_api_util.js");

var _todo_api_util2 = _interopRequireDefault(_todo_api_util);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.fetchTodos = _todo_api_util2.default;
...
var _util = __webpack_require__(/*! ../../util/util */ "./frontend/util/util.js");
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function handleSubmit(event) {
      ...
      var todo = { id: (0, _util.uniqueId)(), title: title, body: body };
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'textarea',
            { type: 'textarea', value: this.state.body, onChange: this.handleChange },
            ' '
          )
        ),
...
var TodoListContainer = function TodoListContainer(props) {
  console.log(props.removeTodo);
  var listItems = props.todos.map(function (todo, idx) {
    return _react2.default.createElement(_todo_list_item2.default, { key: idx, todo: todo, removeTodo: props.removeTodo });
  });
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    case _todo_actions.RECEIVE_TODO:
      ...
      stateCopy = (0, _merge2.default)({}, state);
